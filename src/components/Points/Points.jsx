            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 mb-4">
                        <div className="d-flex gap-3">
                            <div className="number">
                                <span className="bg-primary py-2 px-4 fs-3 rounded-circle">2</span>
                            </div>
                            <div>
                    ...
                    <div className="col-md-6 mb-4">
                        <div className="d-flex gap-3">
                            <div className="number">
                                <span className="bg-primary py-2 px-4 fs-3 rounded-circle">3</span>
                            </div>
                            <div>
                    ...
                    <div className="col-md-6 mb-4">
                        <div className="d-flex gap-3">
                            <div className="number">
                                <span className="bg-primary py-2 px-4 fs-3 rounded-circle">4</span>
                            </div>
                            <div>
                    ...
                    <div className="col-md-6 mb-4">
                        <div className="d-flex gap-3">
                            <div className="number">
                                <span className="bg-primary py-2 px-4 fs-3 rounded-circle">5</span>
                            </div>
                            <div>
                    ...
                    <div className="col-md-6 mb-4">
                        <div className="d-flex gap-3">
                            <div className="number">
                                <span className="bg-primary py-2 px-4 fs-3 rounded-circle">6</span>
                            </div>
                            <div>
